...
<template>
  <div class="flex justify-center min-h-screen bg-gray-900 sm:items-center">
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css" rel="stylesheet">
    <div class="max-w-4xl mx-auto lg:px-8">
      <!-- <h1 class="leading-7 text-light text-center font-bold">
        Universal Click Counter
      </h1> -->
      ...
      <br/><br/><br/>
      <p class="mt-3 mb-5 h3 text-center text-gray-500">
        We have started at October 17th, 2022 at 07:04GMT. <br>
        Since then, it's up to you.<br>
      </p>
      <p class="mt-5 h5 text-center text-gray-500">
        You may support us by clicking below: <br>
      </p>
      ...
      <footer class="flex justify-center space-x-3 mb-5 fixed-bottom">
        <a href="https://github.com/octi14/universal-click-counter" target="_blank"><svg
          class="w-7 mt-1 h-6 text-gray-600 hover:text-gray-800"
          aria-hidden="true"
          role="img"
          width="32"
          height="32"
        ...
        <a href="https://instagram.com/octi.gonzalez" target="_blank"><svg
